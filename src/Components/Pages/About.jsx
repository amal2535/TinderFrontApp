    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="bg-white w-screen min-h-screen flex flex-col dark:bg-gray-900 dark:text-white pt-32 px-7 gap-3">
                <h1 className="text-5xl self-center font-bold mb-7">{t('aboutus')}</h1>
                <div className="flex flex-col gap-4 px-7 py-4 bg-gray-200 rounded-lg border-2 border-gray-400 dark:border-gray-500 dark:bg-gray-700 ">
                    <h1 className="md:text-4xl text-2xl font-bold">{t('welcome')}</h1>
                    <p className="text-lg text-gray-700 dark:text-gray-300">{t('here')}</p>
                </div>
                <div className="flex flex-col gap-4 px-7 py-4 bg-gray-200 rounded-lg border-2 border-gray-400 dark:bg-gray-700 dark:border-gray-500">
                    <h1 className="md:text-4xl text-2xl font-bold">{t('ourmission')}</h1>
                    <p className="text-lg text-gray-700 dark:text-gray-300"><span className="font-semibold dark:text-gray-200 text-gray-800">{t('connecting')}</span> {t('hearts')}</p>
                </div>
                <div className="flex flex-col gap-4 px-7 py-4 bg-gray-200 rounded-lg border-2 border-gray-400 dark:bg-gray-700 dark:border-gray-500">
                    <h1 className="md:text-4xl text-2xl font-bold">{t('howit')}</h1>
                    <p className="text-lg text-gray-700 dark:text-gray-300">{t('herewebegan')}</p>
                </div>
                <div className="flex flex-col gap-4 px-7 py-4 bg-gray-200 rounded-lg border-2 border-gray-400 dark:bg-gray-700 dark:border-gray-500">
                ...
                <div className="flex flex-col gap-4 px-7 py-4 bg-gray-200 rounded-lg border-2 border-gray-400 dark:bg-gray-700 dark:border-gray-500 mb-8">
                    <h1 className="md:text-4xl text-2xl font-bold">{t('joinus')}</h1>
                    <p className="text-lg text-gray-700 dark:text-gray-300 flex gap-4 flex-col">{t('weinvite')}<br/> <span className="self-center font-semibold text-gray-200"> {t('thanku')}  </span></p>
                </div>
            </div>
            <Footer />
        </div>
